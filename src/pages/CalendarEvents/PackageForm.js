...
function PacakgeDialog({ onClose, selectedValue, open } ) {
//   const { onClose, selectedValue, open } = props;
  
  const [Pacakge,setPacakge]=React.useState({
  ...
  const handlePacakge=(value,name)=>{
        setPacakge((prevState) => ({
            ...prevState,
            [name]: value
        }));
  }
